...
const Skill = () => {
  return (
    <div className='group relative flex cursor-pointer top-[80px] sm:top-[50px]'>
        <motion.img
        initial={{
            opacity: 0
        }}
        ...
        className='mx-auto rounded-full object-cover border-gray-500 w-24 h-24 xl:w-22 xl:h-22 filter group-even:grayscale transition duration-300 ease-in-out md:w-28 md:h-28'
       ...
       <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-24 w-24 md:w-24 md:h-24 xl:w-28 xl:h-28 rounded-full z-0'>
